...
class AccountScreen extends StatelessWidget {
  ...
  // Use a getter method to lazily initialize the list.
  // This allows cartController to be accessed properly since it's initialized beforehand.
  List<AccountsTile> get accountTiles => [
        AccountsTile(
          title: 'Purchases',
        ...
        AccountsTile(
          ...
          icon: Icons.favorite,
          onTap: () {
            // Set the cart screen index to 1 to display wishlist
